...
# Website: https://free.currencyconverterapi.com/free-api-key
...
class CurrencyConverterApp:
    ...
    def handle_tab_changed(self, event):
        ...
        if tab == "Conversion Rate":
            ...
            country1_currency_name = self.country_currency_dict[country1_name][1]
            country2_currency_name = self.country_currency_dict[country2_name][1]

            country1_currency_symbol = self.country_currency_dict[country1_name][2]
            country2_currency_symbol = self.country_currency_dict[country2_name][2]

            self.conversion_rate_frame.pack_forget()
            WinConvert(self.convert_frame, conversion_rate, country1_currency_name, country1_currency_symbol,
